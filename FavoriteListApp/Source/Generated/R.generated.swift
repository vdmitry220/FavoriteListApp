...
struct R: Rswift.Validatable {
  ...
  struct storyboard {
    ...
    /// Storyboard `NewFilm`.
    static let newFilm = _R.storyboard.newFilm()
    ...
    #if os(iOS) || os(tvOS)
    /// `UIStoryboard(name: "NewFilm", bundle: ...)`
    static func newFilm(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.newFilm)
    }
    #endif
